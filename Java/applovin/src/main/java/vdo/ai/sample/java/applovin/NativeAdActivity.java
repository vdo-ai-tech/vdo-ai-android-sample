...
import vdo.ai.sample.java.applovin.databinding.ActivityNativeAdBinding;

public class NativeAdActivity extends AppCompatActivity {

    private ActivityNativeAdBinding binding;
    private String TAG = NativeAdActivity.class.getSimpleName();
    private VdoApplovinNativeAd nativeAd ;
    @Override
    ...
    private void example(){
        ...
        nativeAd = new VdoApplovinNativeAd.VdoApplovinNativeAdBuilder()
